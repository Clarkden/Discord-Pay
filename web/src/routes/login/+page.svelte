...
<section class="flex flex-col items-center h-screen w-full">
  ...
  >
    <div
      class="max-w-[500px] md:w-[500px] bg-white rounded-md p-5 text-black flex flex-col gap-3 border border-black py-10 drop-shadow-md"
    >
      ...
      >
        ...
        <p>
          Don't have an account yet? <span class="font-bold"
            ><a href="/register">Regster</a></span
          >
        </p>
        {#if loading === "loading"}
          <button
            class="w-full py-2 rounded-md border-2 border-black bg-black text-white hover:bg-neutral-900"
            disabled
          >
            <div role="status">
              <svg
